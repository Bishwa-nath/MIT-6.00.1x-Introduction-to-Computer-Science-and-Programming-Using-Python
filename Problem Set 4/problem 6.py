...
# play the wordgame with different hand sizes by modifying only the variable HAND_SIZE.
...
def playGame(wordList):
    ...
    while True:
        s = str(input('Enter n to deal a new hand, r to replay the last hand, or e to end game: '))
        if s == 'e':
            break
        elif s == 'n':
